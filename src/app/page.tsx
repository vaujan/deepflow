...
export default function Page() {
	return (
		<div className="flex flex-col bg-gray-2 min-h-screen lg:flex-row">
			{/* Container */}
			<main
				className={`flex flex-col flex-1 items-start justify-start gap-4 pb-20 overflow-hidden min-h-0`}
			>
				<Header />
